...
void static_local_example() {
    static int another_number {5000};      // IMPORTANT
                                 // local to static_local_example static -
                                 // ** retains it value between calls **
    cout << "\nLocal static  num is: " << another_number << " in static_local_example - start" << endl;
    another_number += 1000;
    cout << "Local static  num is: " << another_number << " in static_local_example - end" << endl;
}
