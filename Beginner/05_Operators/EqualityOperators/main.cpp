...
int main() {
    ...
    cout << boolalpha;      // will display true/false instead of 1/0 for booleans
                            // To turn off somewhere in the code use `noboolalpha`
...
//    cout << "Comparision result (not equals) : " << not_equal_result << endl;
    ...
    cin >> num1 >> double1;
    equal_result = (num1 == double1);  // promotion int in double
    not_equal_result = (num1 != double1);  // promotion int in double
    cout << "Comparision result (equals) : " << equal_result << endl;
    cout << "Comparision result (not equals) : " << not_equal_result << endl;
